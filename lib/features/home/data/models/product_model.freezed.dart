...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductRatingModel&&(identical(other.rate, rate) || other.rate == rate)&&(identical(other.count, count) || other.count == count));
}
...
class _ProductRatingModel extends ProductRatingModel {
  const _ProductRatingModel({required this.rate, required this.count}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductRatingModel&&(identical(other.rate, rate) || other.rate == rate)&&(identical(other.count, count) || other.count == count));
}
...
mixin _$ProductModel {
 ...
 int get id; String get title; double get price; String get description; String get category;@JsonKey(name: 'image') String get image; ProductRatingModel get rating;
...
@useResult
$Res call({
 int id, String title, double price, String description, String category,@JsonKey(name: 'image') String image, ProductRatingModel rating
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  double price,  String description,  String category, @JsonKey(name: 'image')  String image,  ProductRatingModel rating)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  double price,  String description,  String category, @JsonKey(name: 'image')  String image,  ProductRatingModel rating)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.id,_that.title,_that.price,_that.description,_that.category,_that.image,_that.rating);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  double price,  String description,  String category, @JsonKey(name: 'image')  String image,  ProductRatingModel rating)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.id,_that.title,_that.price,_that.description,_that.category,_that.image,_that.rating);case _:
  return null;
...
class _ProductModel extends ProductModel {
  const _ProductModel({required this.id, required this.title, required this.price, required this.description, required this.category, @JsonKey(name: 'image') required this.image, required this.rating}): super._();
...
@override final  ProductRatingModel rating;
